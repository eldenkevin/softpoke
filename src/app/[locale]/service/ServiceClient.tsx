...
const ServiceClient = () => {
  ...
  return (
    <section className="bodySection bodySection-Service">
      ...
      <h1 className="bodyTitle02" dangerouslySetInnerHTML={{ __html: t.raw('service.title2') }} />

      <h2 className="bodyDesc01">{t('service.description')}</h2>
      <Divider />
      ...
      <div className="serviceBox01">
        <div className="serviceBox01-Wrap">
          ...
          <div className="serviceBox01-Desc">
            <div className="service-checklist">
              {(t.raw('service.brand.items') as string).split('<br />').map((item, index) => (
                <div
                  key={`brand-${index}`}
        ...
        <div className="serviceBox01-Wrap">
          ...
          <div className="serviceBox01-Desc">
            <div className="service-checklist">
              {(t.raw('service.design.items') as string).split('<br />').map((item, index) => (
                <div
                  key={`design-${index}`}
                  className="service-item"
                  onMouseEnter={() => {
        ...
        <div className="serviceBox01-Wrap">
          ...
          <div className="serviceBox01-Desc">
            <div className="service-checklist">
              {(t.raw('service.development.items') as string).split('<br />').map((item, index) => (
                <div
                  key={`dev-${index}`}
                  className="service-item"
                  onMouseEnter={() => {
      ...
      <div className="serviceBox02">
        <div className="serviceBox02-Wrap">
          <div className="serviceBox02-No"><p>01</p></div>
          <div className="serviceBox02-Title"><p>{t('service.process.discovery.title')}</p></div>
          <div className="serviceBox02-Desc">
            <p dangerouslySetInnerHTML={{ __html: t.raw('service.process.discovery.description') }} />
          </div>
        </div>
        <div className="serviceBox02-Wrap">
          <div className="serviceBox02-No"><p>02</p></div>
          <div className="serviceBox02-Title"><p>{t('service.process.conceptualization.title')}</p></div>
          <div className="serviceBox02-Desc">
            <p dangerouslySetInnerHTML={{ __html: t.raw('service.process.conceptualization.description') }} />
          </div>
        </div>
        <div className="serviceBox02-Wrap">
          <div className="serviceBox02-No"><p>03</p></div>
          <div className="serviceBox02-Title"><p>{t('service.process.creation.title')}</p></div>
          <div className="serviceBox02-Desc">
            <p dangerouslySetInnerHTML={{ __html: t.raw('service.process.creation.description') }} />
          </div>
        </div>
      </div>
